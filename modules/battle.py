...
RARITY_STATS = {
    ...
    "Elite": {"atk": 120, "spe": 115, "hp": 125, "def": 120},
    "Limited Edition": {"atk": 135, "spe": 130, "hp": 140, "def": 135},
    "Ultimate": {"atk": 150, "spe": 145, "hp": 155, "def": 150},
    "Premium": {"atk": 165, "spe": 160, "hp": 170, "def": 165},
    "Supreme": {"atk": 180, "spe": 175, "hp": 185, "def": 180},
    "Mythic": {"atk": 195, "spe": 190, "hp": 200, "def": 195},
    "Zenith": {"atk": 210, "spe": 205, "hp": 215, "def": 210},
    "Ethereal": {"atk": 225, "spe": 220, "hp": 230, "def": 225},
    "Mega Evolution": {"atk": 240, "spe": 235, "hp": 245, "def": 240}
}
...
RARITY_MOVES = {
    ...
    "Ethereal": [
        {"name": "Ethereal Blast", "power": 180, "accuracy": 100, "type": "Psychic", "effect": "Ethereal power attack"},
        {"name": "Ethereal Storm", "power": 180, "accuracy": 100, "type": "Flying", "effect": "Ethereal storm attack"},
        {"name": "Ethereal Surge", "power": 180, "accuracy": 100, "type": "Electric", "effect": "Ethereal surge attack"},
        {"name": "Ethereal Void", "power": 180, "accuracy": 100, "type": "Ghost", "effect": "Ethereal void attack"}
    ],
    "Mega Evolution": [
    ...
    async def show_battle_results(self, battle: Battle, client: Client):
        ...
        try:
            ...
            if winner_id:
                ...
                # Add last few battle log entries with better formatting
                for log_entry in battle.battle_log[-5:]:
                    if "missed" in log_entry.lower():
                        result_text += f"💨 {log_entry}\n"
                    elif "fainted" in log_entry.lower():
                        result_text += f"💀 {log_entry}\n"
                    elif "Critical hit" in log_entry:
                        result_text += f"⚡ {log_entry}\n"
                    else:
                        result_text += f"⚔️ {log_entry}\n"
                
                # Add battle summary
                result_text += f"\n<b>Battle Summary:</b>\n"
                result_text += f"• <a href='tg://user?id={winner_id}'>{winner_name}</a> emerged victorious after {total_rounds} rounds!\n"
                result_text += f"• The battle lasted {duration_seconds} seconds\n"
                result_text += f"• Total damage dealt: {total_damage} HP\n"
...
def setup_battle_handlers(app: Client):
    ...
    app.on_callback_query(filters.regex(r"^(accept_battle_|decline_battle_|use_move_|view_team_|back_to_switch_|switch_pokemon_)"))(battle_callback_handler)
