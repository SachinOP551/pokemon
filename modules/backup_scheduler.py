    ...
    async def send_backup_to_channel(self, backup_path: str):
        ...
        try:
            ...
            caption = (
                ...
                f"📦 **Format:** PostgreSQL Custom Dump (compressed)\n\n"
                f"💾 This backup contains the complete PostgreSQL database in custom dump format.\n"
                f"🔧 To restore: `pg_restore -d database_name {filename}`"
            )
