...
def get_store_keyboard(refreshes):
    buttons = []
    # Add buy button
    buttons.append([InlineKeyboardButton("🛒 Buy Pokémon", callback_data="buy_from_store")])
...
async def buy_from_store_callback(client: Client, callback_query: CallbackQuery):
    ...
    await callback_query.message.reply(
        "🛒 <b>Buy Pokémon from Store</b>\n\n"
        "Please enter the ID of the Pokémon you want to buy:\n"
        "Example: `123`"
    )
    await callback_query.answer("Please enter the Pokémon ID")
