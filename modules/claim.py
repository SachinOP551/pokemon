...
async def claim_command(client: Client, message: Message):
    ...
    try:
        ...
        if last_claim and not is_owner:
            ...
            if datetime.now() < next_claim:
                ...
                await message.reply_text(
                    f"<b>❌ ʏᴏᴜ'ᴠᴇ ᴀʟʟʀᴇᴀᴅʏ ᴄʟᴀɪᴍᴇᴅ ʏᴏᴜʀ ᴅᴀɪʟʏ ᴄʜᴀʀᴀᴄᴛᴇʀ!</b>\n"
        ...
        if not character:
            await message.reply_text(
                "<b>❌ ɴᴏ ᴄʜᴀʀᴀᴄᴛᴇʀs ᴀᴠᴀɪʟᴀʙʟᴇ ɪɴ ᴛʜᴇ ᴅᴀᴛᴀʙᴀsᴇ!</b>",
            )
            return
        ...
        caption = (
            f"<b>🌙 {message.from_user.first_name} ʏᴏᴜ ɢᴏᴛ ᴀ ɴᴇᴡ ᴄʜᴀʀᴀᴄᴛᴇʀ!</b>\n\n"
        ...
        try:
            ...
            await message.reply_text(
                f"{caption}\n\n<b>⚠️ ᴄᴏᴜʟᴅ ɴᴏᴛ ʟᴏᴀᴅ ᴄʜᴀʀᴀᴄᴛᴇʀ ᴍᴇᴅɪᴀ!</b>",
            )
    finally:
