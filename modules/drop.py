...
# Epic drop captions
DROP_CAPTIONS = [
    "⚡ Aɴ ᴀᴜʀᴀ ᴇxᴘʟᴏᴅᴇs ꜰʀᴏᴍ ᴛʜᴇ ʙᴀᴛᴛʟᴇꜰɪᴇʟᴅ…\nA ᴡᴀʀʀɪᴏʀ ᴏꜰ ᴀɴɪᴍᴇ ᴅᴇsᴛɪɴʏ ᴀᴡᴀᴋᴇɴs.\n🔥 /collect name ᴛᴏ ᴄʟᴀɪᴍ ᴛʜᴇɪʀ ꜰɪɢʜᴛɪɴɢ sᴘɪʀɪᴛ.",
    "🌙 A ᴄᴜʀsᴇᴅ ᴘᴏᴡᴇʀ sᴛɪʀs ɪɴ ᴛʜᴇ sʜᴀᴅᴏᴡs…\nOɴʟʏ ᴏɴᴇ ᴡɪʟʟ ᴅᴀʀᴇ ᴛᴏ ʙɪɴᴅ ɪᴛ.\n👁️ /collect name ᴛᴏ ᴡᴇɪʟᴅ ᴛʜᴇ ꜰᴏʀʙɪᴅᴅᴇɴ ꜰᴏʀᴄᴇ.",
    "📜 Tʜᴇ ʟᴏsᴛ sᴄʀᴏʟʟ ᴏᴘᴇɴs…\nA ɴᴀᴍᴇ ᴇɴɢʀᴀᴠᴇᴅ ɪɴ ᴀɴɪᴍᴇ ʟᴇɢᴇɴᴅs ʀᴇᴀᴡᴀᴋᴇɴs.\n🗝️ /collect name ᴛᴏ ᴄʟᴀɪᴍ ᴛʜᴇɪʀ sᴇᴄʀᴇᴛ.",
    "🔥 Fʟᴀᴍᴇs ʀᴏᴀʀ, ᴡᴀᴛᴇʀ ꜱᴜʀɢᴇs, ᴀɴᴅ ᴡɪɴᴅ sᴄʀᴇᴀᴍs…\nA ʜᴇʀᴏ ᴏꜰ ᴛʜᴇ ᴇʟᴇᴍᴇɴᴛs ᴇᴍᴇʀɢᴇs.\n🌊 /collect name ᴛᴏ ᴍᴀsᴛᴇʀ ᴛʜᴇɪʀ ᴀʀᴛs.",
    "🩸 A ʀɪᴠᴀʟʀʏ ʙᴏʀɴ ᴏꜰ ʙʟᴏᴏᴅ ᴀɴᴅ ᴅʀᴇᴀᴍs…\nTʜᴇɪʀ ꜱᴘɪʀɪᴛ ᴄᴀʟʟs ᴛᴏ ʏᴏᴜ.\n⚔️ /collect name ᴛᴏ ꜰᴏʀɢᴇ ᴀ ʙᴏɴᴅ.",
    "💫 A ᴘᴏʀᴛᴀʟ ᴛᴏ ᴀɴᴏᴛʜᴇʀ ᴡᴏʀʟᴅ ᴏᴘᴇɴs…\nA ɪsᴇᴋᴀɪ ᴡᴀʀʀɪᴏʀ ᴀᴘᴘᴇᴀʀs ꜰʀᴏᴍ ʙᴇʏᴏɴᴅ.\n🚪 /collect name ᴛᴏ ᴍᴀᴋᴇ ᴛʜᴇɪʀ ᴘᴏᴡᴇʀ ʏᴏᴜʀs.",
    "⚡ Tʜᴇ ᴘᴏᴡᴇʀ ᴏꜰ ᴀ ᴛʜᴏᴜsᴀɴᴅ ᴛʀᴀɪɴɪɴɢ ᴀʀᴄs ᴇxᴘʟᴏᴅᴇs…\nA ꜱᴜᴘᴇʀ ꜱᴀɪʏᴀɴ ᴇɴᴇʀɢʏ sʜᴀᴛᴛᴇʀs ᴛʜᴇ sᴋʏ.\n🌌 /collect name ᴛᴏ ᴄʟᴀɪᴍ ᴛʜᴇɪʀ ᴘᴏᴡᴇʀ.",
    "🦊 A ᴅᴇᴍᴏɴ ꜰᴏx sᴛɪʀs, ᴄʜᴀɪɴs ʙʀᴇᴀᴋ, ᴀɴᴅ ᴄʜᴀᴋʀᴀ ʙᴜʀɴs…\nTʜᴇɪʀ ꜰᴜʀʏ ɪs ʙᴇʏᴏɴᴅ ᴄᴏɴᴛʀᴏʟ.\n🔒 /collect name ᴛᴏ ᴡɪᴛɴᴇss ᴛʜᴇ ʙᴇᴀsᴛ.",
    "👹 A ᴄᴜʀsᴇᴅ sᴘɪʀɪᴛ ʟᴜʀᴋs ɪɴ ᴛʜᴇ ᴅᴀʀᴋ…\nTʜᴇɪʀ ᴄᴀʟʟ ɪs ɴᴏᴛ ꜰᴏʀ ᴛʜᴇ ᴡᴇᴀᴋ-ʜᴇᴀʀᴛᴇᴅ.\n⚫ /collect name ɪꜰ ʏᴏᴜ ᴅᴀʀᴇ.",
    "🎴 A sᴘɪʀɪᴛ ᴄᴀʀᴅ ɢʟᴏᴡs ᴡɪᴛʜ ᴀɴ ᴜɴᴋɴᴏᴡɴ ꜰᴏʀᴄᴇ…\nA ᴅᴜᴇʟɪsᴛ ʜᴀs ᴀʀʀɪᴠᴇᴅ.\n♠️ /collect name ᴛᴏ sᴇɴᴅ ᴛʜᴇɪʀ ᴘᴏᴡᴇʀ ᴛᴏ ᴛʜᴇ ꜰɪᴇʟᴅ."
]
        ...
        if not message.command or len(message.command) == 1:
            ...
            if user_id in authorized_ids:
                ...
                try:
                    ...
                    msg = (
                        f"<b>✅ Look You Collected A</b> <code>{escaped_rarity}</code> <b>Character</b>\n\n"
                        f"<b>👤 Nᴀᴍᴇ : {escaped_name}</b>\n"
                        f"<b>{rarity_emoji} Rᴀʀɪᴛʏ : {escaped_rarity}</b>\n"
                        f"<b>🎥 Aɴɪᴍᴇ : {character.get('anime', '-') }</b>\n"
                        f"{bonus_text}"
                        f"\n<b>➥ Lᴏᴏᴋ Aᴛ Yᴏᴜʀ Cᴏʟʟᴇᴄᴛɪᴏɴ Usɪɴɢ</b> /mycollection"
                    )
                ...
                async with self.db.pool.acquire() as conn:
                    ...
                    if locked_rarities:
                        rows = await conn.fetch(
                            "SELECT character_id, name, rarity, file_id, img_url, is_video, anime FROM characters WHERE rarity != ALL($1)",
                            locked_rarities
                        )
                    else:
                        rows = await conn.fetch(
                            "SELECT character_id, name, rarity, file_id, img_url, is_video, anime FROM characters"
                        )
