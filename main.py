...
from modules.upload import register_upload_handlers
...
async def canime_handler(client: Client, message: Message):
    """Handle /canime command using the canime module"""
...
async def sethandler_handler(client: Client, message: Message):
    ...
    reserved = {
        "start","claim","collect","mycollection","smode","mystore","sell","gift","trade","fuse","fusioninfo","check","status","search","propose","bal","daily","achievement","tdgoal","vidcollection","vidlist","srarity","droptime","spay","dart","basket","roll","football","sgtop","canime","tdtop","sethandler"
    }
...
@app.on_callback_query(filters.create(lambda _, __, callback_query: callback_query.data in ["edit_name", "edit_anime", "edit_rarity", "edit_image"]))
